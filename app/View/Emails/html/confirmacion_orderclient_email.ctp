...
<!-- inicio contenido de orden --> 
        <tr>         
          <td class="eBody alignLeft" style="margin:0;padding:16px 16px 0;border-collapse:collapse;border-spacing:0;font-family:Arial,Helvetica,sans-serif;text-align:center;width:512px;color:#54565c;background-color:#ffffff;">
			<h1 style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;margin-bottom:5px;font-size:24px;font-weight:bold;line-height:36px;color:#465059;">Confirmación de pago</h1>
            <p style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;margin-bottom:24px;font-size:14px;line-height:22px;text-align:left;">Hola <?php echo $datos['Datos'][0]['Usuario']['nombre'].' '.$datos['Datos'][0]['Usuario']['apellido'];?>, tu pago está confirmado satisfactoriamente. ¡Gracias por tu compra! La(s) tienda(s) enviarán tu compra a la dirección que indicaste.</p>
		  </td>
          <!-- end .highlight--> 
        </tr>
        <tr>
             	...
             	<tbody>
             		<tr>
						<td class="width246" style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;font-family:Arial,Helvetica,sans-serif;display:block !important;padding-right:0 !important;width:246px;text-align:left;vertical-align:top;font-size:12px;color:#a1a2a5;">
							...
							<p style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;margin-bottom:24px;font-size:12px;line-height:19px;text-align:left;color:#a1a2a5;"><?php echo $datos['Datos'][1]['Direccion']['nombre_completo'] .'<br>'. $datos['Datos'][1]['Direccion']['telefono'] . '<br>' .$datos['Datos'][1]['Direccion']['direccion'] .'<br>'. $datos['Datos'][1]['Direccion']['ciudad'] . ' - ' . $datos['Datos'][1]['Provincia']['descripcion'] .'.'?>
        					</p>
       					</td>                
                		<td class="width246 pdRg16" style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;font-family:Arial,Helvetica,sans-serif;padding-right:16px;text-align:left;vertical-align:top;width:246px;font-size:12px;color:#a1a2a5;">
		                	<table cellspacing="0" cellpadding="0" border="0" class="tag" style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;margin-left:0;margin-right:auto;">
		                		<tbody>
		                			<tr>
										<td valign="middle" align="left" class="tagName" style="margin:0;padding:4px 6px;border-collapse:separate !important;border-spacing:0;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:14px !important;text-align:left;color:#ffffff;background-color:#78b8c4;text-transform:uppercase;white-space:nowrap;">Empresa de transporte</td>		 
				                    </tr>
				                 </tbody>
				             </table>
								<p style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;margin-bottom:24px;font-size:12px;line-height:19px;text-align:left;color:#a1a2a5;"><?php echo $datos['Datos']['Envio']['0']['courier'];?>
		        				</p>
        				</td>
                 </tr>
               </tbody>
