...
<!-- inicio contenido de orden --> 
        <tr>
          <td class="highlight pdTp32" style="margin:0;padding:16px 16px 0;border-collapse:collapse;border-spacing:0;font-family:Arial,Helvetica,sans-serif;padding-top:32px;width:512px;text-align:center;background-color:#f9f8fb;">
            <p style="font-size: 23px; font-weight: bold; color:#45c29d">¡Hola <?php echo $datos['Usuario']['nombre'];?>!</p>
            <p style="font-size: 14px; color:#54565c">Recupera el acceso a tu cuenta haciendo clic en el siguiente botón:</p>
          </td>
          <!-- end .highlight--> 
        </tr>
        <tr>
          <td class="eBody alignLeft pdBt16" style="margin:0;border-collapse:collapse;border-spacing:0;font-family:Arial,Helvetica,sans-serif;padding-bottom:16px;width:512px;color:#54565c;background-color:#ffffff;">
            <p style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;margin-bottom:24px;font-size:14px;line-height:22px;"><?php
				...
				array('controller' => 'usuarios', 'action' => 'resetpassword_fromemail', $datos['Usuario']['clave_validacion_email']),
				false);

				echo $this->Html->link(__('Reestablecer clave', true), $url, array('style' => ' color: white;  display: inline-block;    font-size: 18px;    font-weight: normal;    margin-left: 10px;    margin-top: 40px;    padding: 12px 20px;    text-decoration: none;    text-transform: uppercase;	background-color: #45c29d;'));?>
            </p>
