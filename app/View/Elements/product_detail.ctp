    ...
    <div class="container">
      ...
      <div class="six columns omegax">
        <div style="font-size:39px;">
              ...
              <span class=" font-human" style="display: inline; padding-right: 20px; font-weight: bold; text-shadow: 0 0 1px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.3)">  <?php echo $producto['Producto']['precio'];?> Bs. 
            ...
            $cantidad = $this->Form->input('Compra.cantidad', array('value'=> $producto['Producto']['existencia'], 'label' => array('text' => 'Cantidad','class' => 'inline-label font-KG-Manhattan'),'class' => 'input-label-style', 'style' => 'border-width:0px;width:66px;'));
            }
            elseif ($producto['Producto']['existencia'] > 1){
              $j = 1;
            ...
            $cantidad = $this->Form->input('Compra.cantidad', array('options'=> $array_type,'label' => array('text' => 'Cantidad','class' => 'inline-label font-KG-Manhattan'),'class' => 'input-label-style', 'style' => 'border-width:0px;width:66px;'));
              ...
              <div <?php echo $oculta_bloque;?>>
                ...
                <div class="ver_componentes" style="float: right;">
                    <p style="text-shadow: 0 0 1px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.3); margin-right: 35px;" class="fa fa-truck fa-2x fa-flip-horizontal font-human"></p>
                    <div style="margin-top: 10px; background-color: white;z-index: 1;" class="detalles_producto grey">  
                        <ul style="display:block"><?php echo 'Envios por:';
                          $couriers = $producto['Tienda']['couriers'];
                          $couriers_1 =  Configure::read("TIVIA_CONFIG.COURIERS.$couriers");
                           foreach ($couriers_1 as $courier) :?> 
                              <li style="margin-bottom: 0px;"><?php echo $courier;?></li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                </div><?php
      ...
      <div class="three columns omegax">
        <p class="fa fa-heart like-panel morado" style="font-size:20px; text-shadow: 0 0 1px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.3)">
                <span id="success" class="font-human" style="padding-right: 0px; padding-left: 5px;"><?php echo $cant_likes;?> Loves</span>
              </p>
      </div>
        </div>
      </div>
      ...
      <div class="three columns alphax"><?php 
        ...
        <div class="thirteen margin-tienda">
          <span class="font-KG-Manhattan" style="font-size:30px;"><span style="padding-top: 0px; margin-top: 0px; text-shadow: 0 0 1px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.3)">Producto de</span>
