$(function() {
  ...
  if($('#homepage_slider img').length == 1) { $('#homepage_slider .flex-direction-nav').hide() }
    ...
    $cf.on("submit", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
              $cf.prev('.message').html("<em>Thank you for joining our mailing list!</em>");
            }
        });
        e.preventDefault();
