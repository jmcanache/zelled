/* Creditcard.js v0.10.12 | Copyright (c) 2014 Creditcard.js | creditcardjs.com/licensing */(function(){var l,m=this;
...
function Kb(){var a;var b=document;a=b.createElement("div");t?(a.innerHTML="<br><div class=ccjs-csc-diagram-wrapper><div class=ccjs-csc-diagram><div class=ccjs-barcode></div><div class=ccjs-signature>Tres números al dorso de su tarjeta #</div><div class=ccjs-card-code>123</div><div class=ccjs-explanation>En la mayoría de las tarjetas, el código de seguridad se encuentran en el dorso de la tarjeta</div><button type=button class=ccjs-close>&times;</button></div><div class=ccjs-csc-diagram-amex><div class=ccjs-card-number>XXXX XXXXXX XXXXX</div><div class=ccjs-explanation>On American Express cards, the 4-digit security code is on the front, to the top-right of the card number.</div><div class=ccjs-card-code>1234</div><button type=button class=ccjs-close>&times;</button></div></div>",a.removeChild(a.firstChild)):
a.innerHTML="<div class=ccjs-csc-diagram-wrapper><div class=ccjs-csc-diagram><div class=ccjs-barcode></div><div class=ccjs-signature>Tres números al dorso de su tarjeta #</div><div class=ccjs-card-code>123</div><div class=ccjs-explanation>En la mayoría de las tarjetas, el código de seguridad se encuentran en el dorso de la tarjeta.</div><button type=button class=ccjs-close>&times;</button></div><div class=ccjs-csc-diagram-amex><div class=ccjs-card-number>XXXX XXXXXX XXXXX</div><div class=ccjs-explanation>On American Express cards, the 4-digit security code is on the front, to the top-right of the card number.</div><div class=ccjs-card-code>1234</div><button type=button class=ccjs-close>&times;</button></div></div>";
